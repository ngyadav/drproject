          ...
          <div class="our_solution_category">
            <div class="solution_cards_box">
              <div class="solution_card">
                ...
                <div class="solu_description">
                  <p>
                   You can edit all the details of Doctor.
                   But code can't be changed.
                  </p>
                  <a href="./editdoctor.php"><button  type="button" class="read_more_btn">Edit</button></a>
                </div>
              </div>
              <div class="solution_card">
                <div class="hover_color_bubble"></div>
                ...
                <div class="solu_title">
                  <h3>Update Age and Experience</h3>
                </div>
                <div class="solu_description">
                  <p>
                    Update your Age and Experience.
                  </p>
                 <a href="./upagexp.php"> <button type="button" class="read_more_btn">Update</button></a>
                </div>
              </div>
            </div>
            <!--  -->
            <div class="solution_cards_box sol_card_top_3">
              <div class="solution_card">
                ...
                <div class="solu_description">
                  <p>
                    Check the details of registered and update the status of patient.
                  </p>
                  <a href="./showreg.php"><button type="button" class="read_more_btn">Show Registrations</button></a>
                </div>
              </div>
              <div class="solution_card">
                <div class="hover_color_bubble"></div>
                ...
                <div class="solu_description">
                  ...
                  <a href="./logout.php"><button type="button" class="read_more_btn">Log out</button></a>
                </div>
              </div>
            </div>
          </div>
